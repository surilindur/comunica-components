...
/**
 * Comunica RDF join actor for cartesian joins on two unrelated entries.
 */
export class ActorRdfJoinUnrelated extends ActorRdfJoin {
  private readonly mediatorHashBindings: MediatorHashBindings;

  public constructor(args: IActorRdfJoinUnrelatedArgs) {
    super(args, {
      logicalType: 'inner',
...
export interface IActorRdfJoinUnrelatedArgs extends IActorRdfJoinArgs {
  /**
